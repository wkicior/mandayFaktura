...
class InMemoryInvoicesRepository: InvoiceRepository {
    ...
    init() {
        ...
        self.invoices = [Invoice(issueDate: Date(), number: "01/A/2018", sellingDate: Date(), seller: seller, buyer: buyer, items: [], paymentForm: .cash, paymentDueDate: Date()),
                         Invoice(issueDate: Date(), number: "02/A/2018", sellingDate: Date(), seller: seller, buyer: buyer, items: [], paymentForm: .cash, paymentDueDate: Date()),
                         Invoice(issueDate: Date(), number: "03/A/2018", sellingDate: Date(), seller: seller, buyer: buyer, items: [], paymentForm: .cash, paymentDueDate: Date())]
    }
