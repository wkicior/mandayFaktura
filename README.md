...
You may download the binary from [0.2.4 release](https://github.com/wkicior/mandayFaktura/releases/download/release%2F0.2.4/mandayFaktura.app.zip).
...
- Exporting to KSeF (FA 3) XML (alpha)
...
Aplikacja może zostać pobrana z [wydania 0.2.4](https://github.com/wkicior/mandayFaktura/releases/download/release%2F0.2.4/mandayFaktura.app.zip).
