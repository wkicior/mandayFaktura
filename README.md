...
You may download the binary from [0.1.3 release](https://github.com/wkicior/mandayFaktura/releases/download/release%2F0.1.3/mandayFaktura.app.zip).
...
Aplikacja może zostać pobrana z [wydania 0.1.3](https://github.com/wkicior/mandayFaktura/releases/download/release%2F0.1.3/mandayFaktura.app.zip).
