...
You may download the binary from [0.1.4 release](https://github.com/wkicior/mandayFaktura/releases/download/release%2F0.1.4/mandayFaktura.app.zip).
...
Aplikacja może zostać pobrana z [wydania 0.1.4](https://github.com/wkicior/mandayFaktura/releases/download/release%2F0.1.4/mandayFaktura.app.zip).
