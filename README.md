...
You may download the binary from [0.2.5 release](https://github.com/wkicior/mandayFaktura/releases/download/release%2F0.2.5/mandayFaktura.app.zip).
...
Aplikacja może zostać pobrana z [wydania 0.2.5](https://github.com/wkicior/mandayFaktura/releases/download/release%2F0.2.5/mandayFaktura.app.zip).
